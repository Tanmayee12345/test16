...
function Project() {
  ...
  return (
    <div style={divStyle}>
      ...
      <div style={contentStyle}>
        <div style={textContainerStyle}>
          <h1 style={{color:"yellow"}}>Smart Blind Stick using Ardunio</h1>
          <p>
            We have developed a blind stick with a team of two members which is
          </p>
          <p>
            cable of detecting any obstacle and it alerts witha buzzer sound to blind people.
          </p>
        </div>
        <img
